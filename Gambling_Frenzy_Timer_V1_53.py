...
def about():
    ...
    tk.messagebox.showinfo('GF Timer V1.53',
...
def update_countdown():
    ...
    # If the window has already been destroyed, return from the function
    ...
    if not PAUSED:
        ...
        if SECONDS > -1:
            ...
            # Cancel any pending `after` calls before destroying the window
